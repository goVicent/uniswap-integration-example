...
//    address public constant USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    ...
    // function getLuckyNumber() external view returns (
    //         uint96 nonce,
    //         address operator,
    //         address token0,
    //         address token1,
    ...
    //         uint128 tokensOwed0,
    //         uint128 tokensOwed1) =
    //         nonfungiblePositionManager.positions(7509);
    // }
        function getLuckyNumber2() external view returns (address ) {       
        (, address operator, , , , , , , , , , ) =
            nonfungiblePositionManager.positions(7509);
        return operator;
    }

        function getLuckyNumber3() external view returns (address ) {       
        (, , address token0, , , , , , , , , ) =
            nonfungiblePositionManager.positions(7509);
        return token0;
    }
    function approveContract(bool token0, uint amount0, bool token1, uint amount1 )external {
        if (token0){
            TransferHelper.safeApprove(DAI, address(this), amount0);
        }
        if (token1){
            TransferHelper.safeApprove(USDC, address(this), amount1);
        }
    }
    ...
    function _createDeposit(address owner, uint256 tokenId) internal {
        ...
        function beformeMintNewPosition(uint256 amount0ToMint, uint256 amount1ToMint)
        external
    {
        // For this example, we will provide equal amounts of liquidity in both assets.
        // Providing liquidity in both assets means liquidity will be earning fees and is considered in-range.
        // uint256 amount0ToMint = 10;
        // uint256 amount1ToMint = 10;
...
function beforeMintNewPosition2(uint256 amount0ToMint, uint256 amount1ToMint)
        external
        returns (
            uint256 tokenId,
            uint128 liquidity,
